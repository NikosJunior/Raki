...
<body class="app app-signup p-0">
	<div class="row g-0 app-auth-wrapper">
		<div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5 h-100">
					...
					<div class="auth-form-container text-start mx-auto">
						<form class="auth-form auth-signup-form" action="/register" method="post">
							...
							<div class="password mb-3">
								...
								<input id="signup-password_confirm" name="password_confirm" type="password" class="form-control signup-password" placeholder="Create a password" required="required">
							</div>
							...
							<div class="text-center">
								<button type="submit" class="btn app-btn-primary w-100 theme-btn mx-auto mb-3">Sign Up</button>
							</div>
						</form><!--//auth-form-->

						<div class="auth-option text-center mb-1">Already have an account? <a class="text-link" href="login.html">Log in</a></div>
