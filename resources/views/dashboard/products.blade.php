    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                <a class="flex-sm-fill text-sm-center nav-link active" id="produit-all-tab" data-bs-toggle="tab" href="#produit-all" role="tab" aria-controls="produit-all" aria-selected="true">All</a>
                @foreach($categories as $categorie)
                <a class="flex-sm-fill text-sm-center nav-link text-uppercase category" data-bs-toggle="tab" role="tab" data-category-name="{{$categorie->name}}" aria-selected="false">{{$categorie->name}}</a>
                @endforeach
            </nav>
