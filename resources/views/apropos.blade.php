...
<section>
    ...
    <section class="shop-banner">
        <div class="container">
            ...
            <a href="/boutique" class="cart-btn btn-lg">Shop Now</a>
        </div>
    </section>
    <!-- end shop banner -->
                    ...
                    <div class="testimonial-sliders">
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="/assets/user/img/avaters/avatar1.png" alt="">
                            </div>
                        ...
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="/assets/user/img/avaters/avatar2.png" alt="">
                            </div>
                            <div class="client-meta">
                        ...
                        <div class="single-testimonial-slider">
                            <div class="client-avater">
                                <img src="/assets/user/img/avaters/avatar3.png" alt="">
                            </div>
                            <div class="client-meta">
